export const sseo_colors = {
			"Preset color palette.": {
				...
				"body": ["$$turquoise: #1abc9c;","$$green-sea: #16a085;","$$emerald: #2ecc71;","$$nephritis: #27ae60;"],
				"description":  "Preset color palette."
			},
			
			"Preset color palette.": {
				"prefix": "sseo-palette-blue",
				"body": ["$$peter-river: #3498db;","$$belize-hole: #2980b9;","$$wet-asphalt: #34495e;","$$midnight-blue: #2c3e50;"],
				"description":  "Preset color palette."
			},
			...
			"Preset color palette.": {
				...
				"body": ["$$sun-flower: #f1c40f;","$$orange: #f39c12;","$$carrot: #e67e22;"],
				"description":  "Preset color palette."
			},
			
			"Preset color palette.": {
				"prefix": "sseo-palette-red",
				"body": ["$$pumpkin: #d35400;","$$alizarin: #e74c3c;","$$pomegranate: #c0392b;"],
				"description":  "Preset color palette."
			},
			
			"Preset color palette.": {
				"prefix": "sseo-palette-gray",
				"body": ["$$clouds: #ecf0f1;","$$silver: #bdc3c7;","$$concrete: #95a5a6;","$$asbestos: #7f8c8d;"],
				"description":  "Preset color palette."
			},
			
			"A function that returns the color pastel as an argument.": {
			...
			"A function that returns the complement of a color (used to determine a graphic charter).": {
				...
				"description":  "A function that returns the complement of a color (used to determine a graphic charter)."
			}
			};