...
window.Typekit.config = {
  ...
  dl: 'AAAASAAAAArxRFlHW66buQAAALY',
  fi: [139, 171, 173, 175, 5474, 6812, 6813, 6814, 6817],
  fc: [
    {
      id: 139,
      family: 'proxima-nova',
      src: 'https://use.typekit.net/af/bc719c/00000000000000000001499c/23/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '700', style: 'normal', subset_id: 2 },
    },
    {
      id: 171,
      family: 'proxima-nova',
      src: 'https://use.typekit.net/af/3ba24d/0000000000000000000148a0/23/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '100', style: 'normal', subset_id: 2 },
    },
    {
      id: 173,
      family: 'proxima-nova',
      src: 'https://use.typekit.net/af/e0b8be/0000000000000000000148a6/23/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '600', style: 'normal', subset_id: 2 },
    },
    {
      id: 175,
      family: 'proxima-nova',
      src: 'https://use.typekit.net/af/42fca5/0000000000000000000148a4/23/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '400', style: 'normal', subset_id: 2 },
    },
    {
      id: 5474,
      family: 'proxima-nova',
      src: 'https://use.typekit.net/af/3d81f6/0000000000000000000148a2/23/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '300', style: 'normal', subset_id: 2 },
    },
    {
      id: 6812,
      family: 'minion-pro',
      src: 'https://use.typekit.net/af/205092/0000000000000000000151d1/23/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '700', style: 'normal', subset_id: 2 },
    },
    {
      id: 6813,
      family: 'minion-pro',
      src: 'https://use.typekit.net/af/c90ebf/0000000000000000000151d2/23/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '700', style: 'italic', subset_id: 2 },
    },
    {
      id: 6814,
      family: 'minion-pro',
      src: 'https://use.typekit.net/af/94bd2d/0000000000000000000151d3/23/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '400', style: 'italic', subset_id: 2 },
    },
    {
      id: 6817,
      family: 'minion-pro',
      src: 'https://use.typekit.net/af/deb88c/0000000000000000000151d6/23/{format}{?primer,subset_id,fvd,v}',
      descriptors: { weight: '400', style: 'normal', subset_id: 2 },
    },
  ],
  fn: [
