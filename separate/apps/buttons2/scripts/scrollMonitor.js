;(function (factory) {
  ...
  function debouncedRecalcuateAndTrigger() {
    ...
    recalculateAndTriggerTimer = setTimeout(
      recalculateWatchLocationsAndTrigger,
      100,
    )
  }
  ...
  ElementWatcher.prototype = {
    ...
    update: function () {
      ...
      this.isInViewport =
        this.top <= exports.viewportBottom && this.bottom >= exports.viewportTop
      this.isFullyInViewport =
        (this.top >= exports.viewportTop &&
          this.bottom <= exports.viewportBottom) ||
  ...
  try {
    ...
    try {
      ...
      throw new Error(
        'If you must put scrollMonitor in the <head>, you must use jQuery.',
      )
    }
  }
