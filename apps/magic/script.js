...
!(function (e, t) {
  ...
  var F = function e(t, n, r, i, o, a, s) {
      var u = 0,
        l = t.length,
        c = null == r
      if ('object' === x(r)) for (u in ((o = !0), r)) e(t, n, u, r[u], !0, a, s)
      else if (
        void 0 !== i &&
        ((o = !0),
        g(i) || (s = !0),
  ...
  b.ajaxSetup({
    ...
    b.each(['top', 'left'], function (e, t) {
      b.cssHooks[t] = ze(h.pixelPosition, function (e, n) {
        if (n) return (n = Be(e, t)), We.test(n) ? b(e).position()[t] + 'px' : n
      })
    }),
          ...
          fn: function (e) {
            ...
            if (o) {
              var r = e.offsets,
                ...
                a = s ? 'left' : 'top',
                p = s ? 'width' : 'height',
                l = { start: Q({}, a, i[a]), end: Q({}, a, i[a] + i[p] - f[p]) }
              ...
              e(this._element)
                .one(c.TRANSITION_END, function () {
                  t.setTransitioning(!1),
                    e(t._element).removeClass(et).addClass(tt).trigger(J.HIDDEN)
                })
                .emulateTransitionEnd(l)
            }
          }
            ...
            [
              {
                ...
                value: function () {
                  ...
                  ;(this.action =
                    ...
                    (this.container =
                      'object' === o(t.container) ? t.container : document.body)
                },
              },
              {
                key: 'listenClick',
